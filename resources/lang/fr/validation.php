...
return [
    ...
    | telles que les règles de taille. N'hésitez pas à ajuster chaque message ici.
    |
    */
    ...
    'required_array_keys' => 'Le champ :attribute doit contenir des entrées pour les clés :values.',
